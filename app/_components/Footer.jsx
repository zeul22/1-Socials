          ...
          <div className="flex flex-col items-center gap-4 rounded-lg bg-indigo-600 p-6 shadow-lg sm:flex-row sm:justify-between">
            ...
            >
              {isSignedIn ? (
                ...
                className="text-sm font-medium bg-transparent text-black hover:bg-transparent">
                  {" "}
                  Let's Get Started{" "}
                  <svg
          ...
          <div className="mt-16">
            ...
            <div className="mt-16 sm:flex sm:items-center sm:justify-between">
              <div className="flex items-center justify-center sm:justify-start">
                <Image src={"/1_socials.png"} height={100} width={100} alt="" />
                <div className="text-3xl font-bold tracking-tighter">1 Socials</div>
              </div>
